	...
	foreach ( $packages as $i => $package ) {
		...
		wc_get_template(
			...
			array(
				...
				'package_name'             => apply_filters( 'woocommerce_shipping_package_name', ( ( $i + 1 ) > 1 ) ? sprintf( _x( 'Shipping %d', 'shipping packages', 'woocommerce' ), ( $i + 1 ) ) : _x( 'Estimated shipping & Handling', 'shipping packages', 'woocommerce' ), $i, $package ),
				'index'                    => $i,
